...
sel = aed.Selection;
startSel = matlab.desktop.editor.positionInLineToIndex(aed, sel(1), 1)
% endSel_orig = matlab.desktop.editor.positionInLineToIndex(aed, sel(3), sel(4))
endSel = matlab.desktop.editor.positionInLineToIndex(aed, sel(3) + 1, 1) - 1
