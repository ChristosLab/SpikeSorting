function plot_cue_evoked_firing_rate(filename)
...
h = colorbar;
h.Label.String = 'Firing rate: cue - baseline (sp/s)';
...
h = colorbar;
h.Label.String = 'Firing rate: cue/baseline (ratio)';
%
ylabel('KS single unit No.')
xlabel('Class sorted correct trial No.')
sgtitle([MatData.beh_file(1:end-4), ' Evoked cue firing rate'], 'Interpreter', 'none')
