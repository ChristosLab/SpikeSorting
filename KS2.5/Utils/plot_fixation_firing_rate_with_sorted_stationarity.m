function plot_fixation_firing_rate_with_sorted_stationarity(filename)
statecode_threshold            = 5;
...
[target_fr, sort_order] = sort_center_of_mass(target_fr .* MatData.stationary(target_cells, target_trials), 1);
%%
